...
if(isset($_POST['address'])){
	...
	if(!(($_POST['utility_electric'] == 'other') or ($_POST['utility_electric'] == 'PAC') or ($_POST['utility_electric'] == 'PGE')) and ($_POST['heat'] == 'electric')){ // if heat is electric and not (PAC, PGE, or other)
	...
	// normalize address
	$eto_soap = new SoapClient("https://forms.energytrust.org/ZP4AddrProvider.asmx?WSDL");
